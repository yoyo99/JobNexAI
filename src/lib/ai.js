 ...
 **/
export function semanticAnalysis(text) {
 ...
 */
export function generateInterviewQuestion(jobDescription) {
 ...
 */
export function analyzeAnswer(answer, question) {
    // Normalisation du texte
 ...
 */
export function rateAnswer(answer, question, jobDescription) {
    // Analyse de la description du poste
    const jobInfo = analyzeJobDescription(jobDescription);
    const lowerCaseAnswer = answer.toLowerCase();
 ...
 */
export function startConversation(jobDescription) {
...
export function getNextQuestion(conversationId) {
    ...
    */
    ...
    export function generateCoverLetter(cv_1, jobDescription_1) {
        return __awaiter(this, arguments, void 0, function* (cv, jobDescription, language = 'fr') { });
    } // Ensure explicit export
    try {
