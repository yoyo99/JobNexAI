...
export function NotificationCenter() {
    ...
    const markAllAsRead = () => __awaiter(this, void 0, void 0, function* () {
        try {
            yield markAllNotificationsAsRead(user === null || user === void 0 ? void 0 : user.id);
