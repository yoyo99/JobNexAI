...
export function CoverLetterGenerator() {
    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsx("h2", { className: "text-xl font-semibold text-white", children: "G\u00E9n\u00E9rateur de lettres de motivation" }), error && (_jsx("div", { className: "bg-red-900/50 text-red-400 p-4 rounded-lg", children: error })), !cv && (_jsx("div", { className: "bg-yellow-900/50 text-yellow-400 p-4 rounded-lg", children: "Veuillez d'abord cr\u00E9er un CV dans la section CV Builder pour utiliser cette fonctionnalit\u00E9." })), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [_jsxs("div", { className: "space-y-4", children: [_jsx("h3", { className: "text-lg font-medium text-white", children: "1. S\u00E9lectionnez une offre d'emploi" }), jobs.length === 0 ? (_jsx("div", { className: "text-center py-6 text-gray-400", children: "Aucune offre d'emploi correspondant \u00E0 votre profil n'a \u00E9t\u00E9 trouv\u00E9e." })) : (_jsx("div", { className: "space-y-2 max-h-96 overflow-y-auto pr-2", children: jobs.map((job) => (_jsxs("div", { className: `bg-white/5 rounded-lg p-4 hover:bg-white/10 transition-colors cursor-pointer ${selectedJobId === job.id ? 'border border-primary-500' : 'border border-transparent'}`, onClick: () => setSelectedJobId(job.id), children: [_jsx("h4", { className: "text-white font-medium", children: job.title }), _jsxs("p", { className: "text-gray-400 text-sm", children: [job.company, " \u2022 ", job.location] }), _jsxs("div", { className: "mt-2 flex justify-between items-center", children: [_jsxs("span", { className: "text-xs bg-primary-600/20 text-primary-400 px-2 py-1 rounded-full", children: [job.matchScore.toFixed(0), "% de correspondance"] }), _jsx("a", { href: job.url, target: "_blank", rel: "noopener noreferrer", className: "text-primary-400 hover:text-primary-300 text-sm", onClick: (e) => e.stopPropagation(), children: "Voir l'offre \u2192" })] })] }, job.id))) }))] }), _jsxs("div", { className: "space-y-4", children: [_jsx("h3", { className: "text-lg font-medium text-white", children: "2. Personnalisez votre lettre" }), _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-400 mb-1", children: "Langue" }), _jsxs("div", { className: "flex gap-2", children: [_jsx("button", { onClick: () => setLanguage('fr'), className: `px-4 py-2 rounded-lg text-sm ${language === 'fr'
