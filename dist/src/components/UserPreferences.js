...
export function UserPreferences() {
    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { children: [_jsx("h3", { className: "text-lg font-medium text-white mb-4", children: "Types de poste" }), _jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-3", children: (Array.isArray(jobTypes) ? jobTypes : []).map((type) => (_jsx("button", { onClick: () => toggleJobType(type.value), className: `px-4 py-2 rounded-lg text-sm font-medium transition-colors ${(preferences === null || preferences === void 0 ? void 0 : preferences.job_types.includes(type.value))
