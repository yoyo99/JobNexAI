...
export function DashboardStats() {
    ...
    const loadStats = () => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const { data: companiesRaw } = yield supabase
                .from('job_applications')
        ...
        `)
            ...
            const stats = {
                ...
                topCompanies: (companies || []).reduce((acc, curr) => {
    ...
    if (!stats)
        return null;
    return (_jsxs("div", { className: "space-y-6", children: [_jsx("div", { className: "flex justify-end space-x-2", children: ['week', 'month', 'year'].map((tf) => (_jsx("button", { onClick: () => setTimeframe(tf), className: `px-4 py-2 rounded-lg text-sm font-medium transition-colors ${timeframe === tf
                        ? 'bg-primary-600 text-white'
                        : 'bg-white/5 text-gray-400 hover:bg-white/10'}`, children: t(`dashboard.timeframe.${tf}`) }, tf))) }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6", children: [_jsxs(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, className: "card", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("div", { className: "p-3 rounded-lg bg-white/5", children: _jsx(BriefcaseIcon, { className: "h-6 w-6 text-primary-400" }) }), _jsx("div", { className: "flex items-center space-x-2", children: _jsxs("span", { className: `text-sm ${stats.applications.percentageChange > 0 ? 'text-green-400' : 'text-red-400'}`, children: [stats.applications.percentageChange > 0 ? (_jsx(ArrowUpIcon, { className: "h-4 w-4 inline" })) : (_jsx(ArrowDownIcon, { className: "h-4 w-4 inline" })), Math.abs(stats.applications.percentageChange).toFixed(1), "%"] }) })] }), _jsxs("div", { className: "mt-4", children: [_jsx("h3", { className: "text-lg font-semibold text-white", children: stats.applications.total }), _jsx("p", { className: "text-sm text-gray-400", children: t('dashboard.stats.applicationsSent') })] })] }), _jsxs(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { delay: 0.1 }, className: "card", children: [_jsx("div", { className: "flex items-center justify-between", children: _jsx("div", { className: "p-3 rounded-lg bg-white/5", children: _jsx(CalendarIcon, { className: "h-6 w-6 text-primary-400" }) }) }), _jsxs("div", { className: "mt-4", children: [_jsx("h3", { className: "text-lg font-semibold text-white", children: stats.interviews.upcoming }), _jsx("p", { className: "text-sm text-gray-400", children: t('dashboard.stats.interviewsUpcoming') })] })] }), _jsxs(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { delay: 0.2 }, className: "card", children: [_jsx("div", { className: "flex items-center justify-between", children: _jsx("div", { className: "p-3 rounded-lg bg-white/5", children: _jsx(BuildingOfficeIcon, { className: "h-6 w-6 text-primary-400" }) }) }), _jsxs("div", { className: "mt-4", children: [_jsx("div", { className: "space-y-2", children: stats.topCompanies.map((company, index) => (_jsxs("div", { className: "flex justify-between items-center", children: [_jsx("span", { className: "text-sm text-gray-400", children: company.name }), _jsx("span", { className: "text-sm text-white", children: company.count })] }, company.name))) }), _jsx("p", { className: "text-sm text-gray-400 mt-2", children: t('dashboard.stats.topCompanies') })] })] }), _jsxs(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { delay: 0.3 }, className: "card", children: [_jsx("div", { className: "flex items-center justify-between", children: _jsx("div", { className: "p-3 rounded-lg bg-white/5", children: _jsx(MapPinIcon, { className: "h-6 w-6 text-primary-400" }) }) }), _jsxs("div", { className: "mt-4", children: [_jsx("div", { className: "space-y-2", children: stats.topLocations.map((location, index) => (_jsxs("div", { className: "flex justify-between items-center", children: [_jsx("span", { className: "text-sm text-gray-400", children: location.name }), _jsx("span", { className: "text-sm text-white", children: location.count })] }, location.name))) }), _jsx("p", { className: "text-sm text-gray-400 mt-2", children: t('dashboard.stats.topLocations') })] })] })] }), _jsxs(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { delay: 0.4 }, className: "card", children: [_jsx("h3", { className: "text-lg font-semibold text-white mb-4", children: t('dashboard.stats.recentActivity') }), _jsx("div", { className: "space-y-4", children: stats.recentActivity.map((activity) => {
                            const Icon = activity.icon || BriefcaseIcon;
                            return (_jsxs("div", { className: "flex items-start gap-4 p-4 rounded-lg bg-white/5", children: [_jsx("div", { className: `p-2 rounded-lg bg-white/5 ${activity.color || 'text-primary-400'}`, children: _jsx(Icon, { className: "h-5 w-5" }) }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsxs("p", { className: "text-sm font-medium text-white truncate", children: [t(`dashboard.activity.${activity.type}`), ": ", activity.title] }), _jsxs("p", { className: "text-sm text-gray-400", children: [activity.company, activity.status && (_jsxs(_Fragment, { children: [_jsx("span", { className: "mx-2", children: "\u2022" }), _jsx("span", { className: "capitalize", children: activity.status })] }))] }), _jsx("p", { className: "text-xs text-gray-500 mt-1", children: format(new Date(activity.date), 'dd MMMM yyyy à HH:mm', { locale: fr }) })] })] }, activity.id));
                        }) })] })] }));
}
