...
export function NetworkList({ onChatWithUser }) {
    ...
    const loadConnections = () => __awaiter(this, void 0, void 0, function* () {
        ...
        `)
            ...
            const fixedData = (data || []).map((conn) => (Object.assign(Object.assign({}, conn), { connected_user: Array.isArray(conn.connected_user) ? conn.connected_user[0] : conn.connected_user })));
