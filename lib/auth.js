...
function signIn(email, password) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (error)
                throw error;
            (0, monitoring_1.trackEvent)('auth.signin.success', {
            ...
            (0, monitoring_1.trackError)(new Error(authError.message), {
                context: 'auth.signin',
                email,
            });
            return {
...
function signUp(email, password) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (user) {
                const { error: subscriptionError } = yield supabase_1.supabase
                    .from('subscriptions')
                    .insert({
                    user_id: user.id,
                    status: 'trialing',
            ...
            (0, monitoring_1.trackEvent)('auth.signup.success', {
                userId: user === null || user === void 0 ? void 0 : user.id,
            });
            return { user, error: null };
        }
...
function signOut() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (error)
                throw error;
            (0, monitoring_1.trackEvent)('auth.signout.success');
            return { error: null };
        }
        catch (error) {
            const authError = error;
...
function resetPassword(email) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { error } = yield supabase_1.supabase.auth.resetPasswordForEmail(email, {
                redirectTo: `${window.location.origin}/auth/reset-password`,
            });
            if (error)
                throw error;
            (0, monitoring_1.trackEvent)('auth.reset_password.requested', {
                email,
            });
            return { error: null };
        }
...
function updatePassword(password) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (error)
                throw error;
            (0, monitoring_1.trackEvent)('auth.password.updated');
            return { error: null };
        }
        catch (error) {
            const authError = error;
