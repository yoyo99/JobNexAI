...
exports.supabase = (0, supabase_js_1.createClient)(supabaseUrl || defaultUrl, supabaseAnonKey || defaultAnonKey);
function getJobs() {
...
function getJobSuggestions(userId) {
    return __awaiter(this, void 0, void 0, function* () {
        const { data: suggestions, error } = yield exports.supabase
...
function getMarketTrends() {
    return __awaiter(this, void 0, void 0, function* () {
        const { data: jobs, error } = yield exports.supabase
            .from('jobs')
            .select('*')
