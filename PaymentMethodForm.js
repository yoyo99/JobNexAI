...
function PaymentMethodFormInner({ onSuccess, onCancel }) {
    ...
    const handleSubmit = (e) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const { error } = yield supabase_1.supabase.functions.invoke('attach-payment-method', {
                body: {
                    userId: user.id,
...
function PaymentMethodForm(props) {
    return ((0, jsx_runtime_1.jsx)(react_stripe_js_1.Elements, { stripe: stripePromise, children: (0, jsx_runtime_1.jsx)(PaymentMethodFormInner, Object.assign({}, props)) }));
}
